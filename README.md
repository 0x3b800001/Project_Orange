...
这是前 OI 选手 xyf 做的玩具项目，从 LemonLime 0.3.5 修改而来，使用了 [LemonLime 一个 fork](https://github.com/Oracynx/LemonLime_Next) 的代码。LemonLime 在 0.3.5 之后停止了对 Linux 下 Qt5 版本（即可以不安装依赖直接运行的版本）的支持，且有几个想要实现的功能，因此有这样一个项目。目前有的新功能：

...
前面误以为最新版本 lemonlime 的 qt6 版本不能直接运行，但是实际上是可以的……抱歉。

这是前 OI 选手 xyf 做的玩具项目，从 LemonLime 0.3.5 修改而来，使用了 [LemonLime 一个 fork](https://github.com/Oracynx/LemonLime_Next) 的代码。目前有的新功能：
